...
// angular:jit:template:src\app\features\dashboard\products\create-product\create-product.html
var create_product_default;
var init_create_product = __esm({
  "angular:jit:template:src\\app\\features\\dashboard\\products\\create-product\\create-product.html"() {
    create_product_default = `<div class="main-create">\r
    @if (loading) {\r
    ...
    <h1>Productos</h1>\r
\r
    <div class="create-product-container">\r
        <header class="create-header">\r
            <h2>\r
                Informaci\xF3n del producto\r
            </h2>\r
            <!--\r
            <p>Errores: {{showErrors()}}</p>\r
            -->\r
\r
\r
\r
...
\r
        <form [formGroup]="createProductForm" class="create-form" (ngSubmit)="onSubmit()">\r
            <div class="form-text">\r
                <label for="name">Nombre del producto</label>\r
                <div class="input-base">\r
                    <input id="name" formControlName="name" type="text" />\r
                </div>\r
                <div class="line"></div>\r
            </div>\r
\r
            <div class="form-text">\r
                <label for="subtitle">Subt\xEDtulo</label>\r
                <div class="input-base">\r
                    <input id="subtitle" formControlName="subtitle" type="text" />\r
                </div>\r
                <div class="line"></div>\r
            </div>\r
\r
            <div class="form-text">\r
                ...
                <div class="desc">\r
                    <div class="input-base">\r
                        <textarea id="description" formControlName="description" class="description"\r
                            maxlength="500"></textarea>\r
                    </div>\r
                    <p class="word-count">{{createProductForm.value.description.length}}/500</p>\r
                </div>\r
\r
                <div class="line"></div>\r
            </div>\r
\r
            <div class="form-text">\r
                <label for="subtitle">Categor\xEDa</label>\r
                <div class="finishes">\r
                    <div class="input-base add-finish" (click)="openFinishModal(1)">\r
                        <label style="flex: 1;">\r
                            {{getCategory()}}\r
                        </label>\r
                        <img src="chevron-down.svg" alt="">\r
\r
                        @if(showDialog === 1){\r
                        <div class="dialog" (click)="$event.stopPropagation()">\r
                            @for (item of categories; track $index) {\r
                            <div class="dialog-item" (click)="selectCategory(item.id); $event.stopPropagation()">\r
                                <p>{{item.nombre}}</p>\r
                            </div>\r
                            }\r
                        </div>\r
...
\r
            <div class="form-text">\r
                <div class="labels">\r
                    <label for="vector">\xCDcono representativo</label>\r
                    <p>Comparte un \xEDcono que sintetice su producto.</p>\r
                </div>\r
\r
                <div class="drag-n-drop">\r
                    @if (canPreview(0)) {\r
                    <div class="vcontainer">\r
                        <img [src]="imagePreview[0]" class="icon-preview" alt="">\r
                    </div>\r
                    }\r
                    <div class="input-base dragndrop" (dragover)="onDragOver($event)"\r
                        (dragleave)="onDragLeave($event, 0)" (drop)="onDrop($event, 0)"\r
                        [ngClass]="{'hover': isHovering}" (click)="onFilesSelected($event, 0)">\r
                        <input type="file" #fileInput (change)="onFileChange($event, 0)" accept="image/*"\r
                            style="display: none;" />\r
                        <div class="upload">\r
                            <img src="upload-cloud.svg" alt="">\r
                        </div>\r
\r
                        <div class="info-upload">\r
                            <p>\r
                                <span class="upload-text">Haga clic para cargar</span> o arrastrar y soltar\r
                            </p>\r
                            <p>SVG, PNG, JPG or GIF</p>\r
                        </div>\r
                    </div>\r
                </div>\r
                <div class="line"></div>\r
            ...
            <div class="form-text">\r
                <label for="subtitle">Acabados</label>\r
                <div class="finishes">\r
                    <div class="input-base add-finish" (click)="openFinishModal(2)">\r
                        <label style="flex: 1;">\r
                            Selecciona los materiales del producto\r
                        </label>\r
                        <!-- dialog.component.html -->\r
                        <img src="chevron-down.svg" alt="">\r
                        @if(showDialog === 2){\r
\r
                        <div class="dialog" (click)="$event.stopPropagation()">\r
                            <div class="dialog-item" (click)="showDialog = 4">\r
                                <img src="plus-circle.svg" alt="">\r
                                <p>Agregar terminaci\xF3n</p>\r
                            </div>\r
\r
                            @for (item of aviableFinishes; track $index) {\r
                            <div class="dialog-item" (click)="addFinish(item); $event.stopPropagation()">\r
                                <div class="avatar">\r
                                    <img [src]="item.image" alt="item.text">\r
                                </div>\r
                                <p>{{item.text}}</p>\r
                                <img src="divide-circle.svg"\r
                                    (click)=" deleteFinish(item.id); $event.stopPropagation();">\r
                            </div>\r
                            }\r
                        </div>\r
\r
                    ...
                    @for (finish of finishes; track $index) {\r
                    <div class="input-base propierty">\r
                        <div class="finish-data">\r
                            <div class="avatar">\r
                                <img [src]="finish.image" alt="">\r
                            </div>\r
                            <p>{{finish.text}}</p>\r
                        </div>\r
                        <img src="divide-circle.svg" alt="delete" (click)="removeFinish(finish.id)">\r
\r
                    </div>\r
                    }\r
                </div>\r
...
\r
            <div class="form-text">\r
                <label for="details">Sistema el\xE9ctrico</label>\r
                <div class="desc">\r
                    <div class="input-base">\r
                        <textarea id="details" formControlName="details" class="description" maxlength="80"></textarea>\r
                    </div>\r
                    <p class="word-count">{{createProductForm.value.details.length}}/80</p>\r
                </div>\r
\r
                <div class="line"></div>\r
            </div>\r
\r
            <div class="form-text">\r
                <label for="name">Tipolog\xEDa</label>\r
\r
                <div class="radio">\r
                    <div class="radio-option-container">\r
                        <div class="radio-option" [ngClass]="{'selected': typology === true}"\r
                            (click)="onTypologyChange(true)">\r
                            @if (typology === true) {\r
                            <div class="selected-circle"></div>\r
                            }\r
                        </div>\r
                        <p class="radio-label">Simple</p>\r
                    </div>\r
                    <div class="radio-option-container">\r
                        <div class="radio-option" [ngClass]="{'selected': typology === false}"\r
                            (click)="onTypologyChange(false)">\r
                            @if (typology === false) {\r
                            <div class="selected-circle"></div>\r
                            }\r
                        </div>\r
                        <p class="radio-label">Variable</p>\r
                    </div>\r
                </div>\r
                <div class="line"></div>\r
            </div>\r
\r
            <div formArrayName="variants" class="varaints-container">\r
\r
                @if(!typology) {\r
                <div class="variant-tab">\r
                    <div class="tabs">\r
                        @for(variant of variants.controls; track $index) {\r
                        <div class="tab" (click)="currentVariant = $index">\r
                            <p>Variable {{$index+1}}</p>\r
                            @if(currentVariant === $index) {\r
                            <div class="selected-tab"></div>\r
                            }\r
                        </div>\r
                        }\r
                        <div class="tab-line"></div>\r
                    </div>\r
\r
                    <button class="button-light" (click)="addVariant()">\r
                        <img src="plus-green.svg" alt="">\r
                        <label>Agregar variable</label>\r
                    </button>\r
                </div>\r
                }\r
\r
                @for (item of variants.controls; track $index) {\r
                @if (currentVariant==$index)\r
                {\r
                <div [formGroupName]="$index" class="variant-item">\r
\r
                    @if(!typology) {\r
                    <div class="default-variant">\r
                        <div class="togle" [ngClass]="{'non-active': defaultVAriant !== currentVariant}"\r
                            (click)="defaultVAriant = currentVariant">\r
                            <div class="switch" [ngClass]="{'non-active': defaultVAriant !== currentVariant}">\r
                                <img src="Button.svg" alt="">\r
                            </div>\r
                        </div>\r
                        <div class="label">\r
                            <p>Producto predeterminado\r
                                <br>\r
                                <span>Este producto aparecer\xE1 como opci\xF3n predeterminada en la galer\xEDa de\r
                                    productos.</span>\r
                            </p>\r
                        </div>\r
                    </div>\r
...
\r
                    <div class="form-text">\r
                        <label>Color</label>\r
                        <div class="finishes">\r
                            <div class="input-base add-finish" (click)="openFinishModal(3)">\r
                                <label style="flex: 1;">\r
                                    Selecciona el color del producto\r
                                </label>\r
                                <img src="chevron-down.svg" alt="">\r
                                @if(showDialog === 3){\r
\r
                                <div class="dialog" (click)="$event.stopPropagation()">\r
                                    <div class="dialog-item" (click)="showDialog = 5">\r
                                        <img src="plus-circle.svg" alt="">\r
                                        <p>Agregar color</p>\r
                                    </div>\r
\r
                                    @for (item of aviavleColors; track $index) {\r
                                    <div class="dialog-item" (click)="onSelectColor(item); $event.stopPropagation()">\r
                                        <div class="avatar">\r
                                            <img [src]="item.image" alt="">\r
                                        </div>\r
                                        <p>{{item.name}}</p>\r
                                        <img src="divide-circle.svg"\r
                                            (click)=" deleteColor(item.id); $event.stopPropagation();">\r
                                    </div>\r
                                    }\r
                                </div>\r
\r
                            ...
                            @if(color[currentVariant]) {\r
                            <div class="input-base propierty">\r
                                <div class="finish-data">\r
                                    <div class="avatar">\r
                                        <img [src]="color[currentVariant]?.image" alt="">\r
                                    </div>\r
                                    <p>{{color[currentVariant]?.name}}</p>\r
                                </div>\r
                                <img src="divide-circle.svg" alt="delete">\r
                            </div>\r
                            }\r
                        </div>\r
                        <div class="line"></div>\r
...
\r
                    <div class="form-text">\r
                        <label for="price">Precio</label>\r
                        <div class="input-base">\r
                            <span class="currency">$</span>\r
                            <input id="price" formControlName="price" type="number" placeholder="0.00"/>\r
                            <span class="currency">USD</span>\r
                        </div>\r
\r
                        <div class="line"></div>\r
                    </div>\r
\r
                    <div class="form-text">\r
                        <label for="stock">Stock</label>\r
                        <div class="count">\r
                            <div class="count-btn" (click)="minus()">\r
                                <img src="/minus.svg" alt="minus">\r
                            </div>\r
                            <input class="prod-count" formControlName="stock" type="number" min="0" />\r
                            <div class="count-btn" (click)="plus()">\r
                                <img src="/plus-black.svg" alt="plus">\r
                            </div>\r
                        </div>\r
                    </div>\r
\r
                    <div class="form-text">\r
                        <div class="labels">\r
                            <label for="vector">Im\xE1genes</label>\r
                            <p>Comparte algunas im\xE1genes del producto.</p>\r
                        </div>\r
\r
                        <div class="variant-images">\r
                            <div class="input-base dragndrop" (dragover)="onDragOver($event)"\r
                                (dragleave)="onDragLeave($event)" (drop)="onDrop($event)"\r
                                [ngClass]="{'hover': isHovering}" (click)="onFilesSelected($event)">\r
                                <input type="file" #fileInputVariants (change)="onFileChange($event)" accept="image/*"\r
                                    style="display: none;" multiple maxlength="5" />\r
\r
                                <div class="upload">\r
                                    <img src="upload-cloud.svg" alt="">\r
                                </div>\r
\r
                            ...
                            <div cdkDropList (cdkDropListDropped)="reorder($event)" class="imges-container">\r
                                @for (preview of getVariantsImages(currentVariant); track preview) {\r
                                <div cdkDrag [cdkDragData]="preview" class="images" [attr.data-index]="$index">\r
                                    <div class="delete-var-image">\r
                                        <img src="divide-circle.svg" alt="" (click)="deleteVarImage($index)">\r
                                    </div>\r
                                    <img [src]="preview.link" class="icon-preview" alt="preview">\r
                                </div>\r
                                }\r
                            </div>\r
                        </div>\r
...
\r
            <footer>\r
                <button class="button-base" type="submit" [disabled]="!createProductForm.valid">\r
                    <label>\r
                        Guardar\r
                    </label>\r
                </button>\r
\r
                <button class="button-chips" (click)="cancel()">\r
                    <label>\r
                        Cancelar\r
                    </label>\r
\r
...
\r
        ...
        <form [formGroup]="createFinish" (submit)="onCreateFinish()">\r
            @if(showDialog == 4){\r
            <div class="overlay" (click)="closeDialog()">\r
                <div class="creation-dialog" (click)="$event.stopPropagation()">\r
                    <h2>Agregar terminaci\xF3n</h2>\r
                    <div class="input-container">\r
                        <label class="form-label">\r
                            Nombre\r
                        </label>\r
                        <div class="input-content">\r
                            <input type="text" formControlName='name'>\r
                        </div>\r
                    </div>\r
                    <p>Imagen</p>\r
                    <div class="upload-img-prop">\r
                        <div class="drag-n-drop">\r
                            <div class="input-base dragndrop add-prop" (dragover)="onDragOver($event,1)"\r
                                (dragleave)="onDragLeave($event,1)" (drop)="onDrop($event,1)"\r
                                [ngClass]="{'hover': isHovering}" (click)="onFilesSelected($event,1)">\r
                                <input type="file" #finish (change)="onFileChange($event, 1)" accept="image/*"\r
                                    style="display: none;" />\r
                                <div class="upload">\r
                                    <img src="upload-cloud.svg" alt="">\r
                                </div>\r
\r
                            ...
                            @if (canPreview(1)) {\r
                            <div class="vcontainer">\r
                                <img [src]="imagePreview[1]" class="icon-preview" alt="">\r
                            </div>\r
                            }\r
                        </div>\r
                    </div>\r
                    <div class="creat-actions">\r
                        <button class="button-chips" style="flex: 1;" (click)="showDialog = 0">\r
                            <label style="font-size: 16px; line-height: 24px;">\r
                                Cancelar\r
                            </label>\r
                        </button>\r
                        <button class="button-base" style="flex:1; padding: 10px 18px;" type="submit">\r
                            <label>\r
                                Guardar\r
                            </label>\r
                        </button>\r
...
\r
        ...
        <form [formGroup]="createColor" (submit)="onCreateColor()">\r
            @if(showDialog == 5){\r
            <div class="overlay" (click)="closeDialog()">\r
                <div class="creation-dialog" (click)="$event.stopPropagation()">\r
                    <h2>Agregar </h2>\r
                    ...
                    <div class="upload-img-prop">\r
                        <div class="drag-n-drop">\r
                            <div class="input-base dragndrop add-prop" (dragover)="onDragOver($event,2)"\r
                                (dragleave)="onDragLeave($event,2)" (drop)="onDrop($event,2)"\r
                                [ngClass]="{'hover': isHovering}" (click)="onFilesSelected($event,2)">\r
                                <input type="file" #color (change)="onFileChange($event, 2)" accept="image/*"\r
                                    style="display: none;" />\r
                                <div class="upload">\r
                                    <img src="upload-cloud.svg" alt="">\r
                                </div>\r
\r
                            ...
                            @if (canPreview(2)) {\r
                            <div class="vcontainer">\r
                                <img [src]="imagePreview[2]" class="icon-preview" alt="">\r
                            </div>\r
                            }\r
                        </div>\r
                    </div>\r
...
var init_drag_drop = __esm({
  "node_modules/@angular/cdk/fesm2022/drag-drop.mjs"() {
    ...
    _ResetsLoader = class __ResetsLoader {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: __ResetsLoader, deps: [], target: FactoryTarget.Component });
      static \u0275cmp = \u0275\u0275ngDeclareComponent({ minVersion: "14.0.0", version: "20.2.0-next.2", type: __ResetsLoader, isStandalone: true, selector: "ng-component", host: { attributes: { "cdk-drag-resets-container": "" } }, ngImport: core_exports, template: "", isInline: true, styles: ["@layer cdk-resets{.cdk-drag-preview{background:none;border:none;padding:0;color:inherit;inset:auto}}.cdk-drag-placeholder *,.cdk-drag-preview *{pointer-events:none !important}\n"], changeDetection: ChangeDetectionStrategy.OnPush, encapsulation: ViewEncapsulation.None });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _ResetsLoader, decorators: [{
      type: Component,
    ...
    DragDropRegistry = class _DragDropRegistry {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDropRegistry, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDropRegistry, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: DragDropRegistry, decorators: [{
      type: Injectable,
      args: [{ providedIn: "root" }]
    }], ctorParameters: () => [] });
    DEFAULT_CONFIG = {
    ...
    DragDrop = class _DragDrop {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDrop, deps: [], target: FactoryTarget.Injectable });
      static \u0275prov = \u0275\u0275ngDeclareInjectable({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDrop, providedIn: "root" });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: DragDrop, decorators: [{
      type: Injectable,
      args: [{ providedIn: "root" }]
    }], ctorParameters: () => [] });
    ...
    CdkDragHandle = class _CdkDragHandle {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _CdkDragHandle, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-next.2", type: _CdkDragHandle, isStandalone: true, selector: "[cdkDragHandle]", inputs: { disabled: ["cdkDragHandleDisabled", "disabled", booleanAttribute] }, host: { classAttribute: "cdk-drag-handle" }, providers: [{ provide: CDK_DRAG_HANDLE, useExisting: _CdkDragHandle }], ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDragHandle, decorators: [{
      type: Directive,
      args: [{
    ...
    CdkDrag = class _CdkDrag {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _CdkDrag, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-next.2", type: _CdkDrag, isStandalone: true, selector: "[cdkDrag]", inputs: { data: ["cdkDragData", "data"], lockAxis: ["cdkDragLockAxis", "lockAxis"], rootElementSelector: ["cdkDragRootElement", "rootElementSelector"], boundaryElement: ["cdkDragBoundary", "boundaryElement"], dragStartDelay: ["cdkDragStartDelay", "dragStartDelay"], freeDragPosition: ["cdkDragFreeDragPosition", "freeDragPosition"], disabled: ["cdkDragDisabled", "disabled", booleanAttribute], constrainPosition: ["cdkDragConstrainPosition", "constrainPosition"], previewClass: ["cdkDragPreviewClass", "previewClass"], previewContainer: ["cdkDragPreviewContainer", "previewContainer"], scale: ["cdkDragScale", "scale", numberAttribute] }, outputs: { started: "cdkDragStarted", released: "cdkDragReleased", ended: "cdkDragEnded", entered: "cdkDragEntered", exited: "cdkDragExited", dropped: "cdkDragDropped", moved: "cdkDragMoved" }, host: { properties: { "class.cdk-drag-disabled": "disabled", "class.cdk-drag-dragging": "_dragRef.isDragging()" }, classAttribute: "cdk-drag" }, providers: [{ provide: CDK_DRAG_PARENT, useExisting: _CdkDrag }], exportAs: ["cdkDrag"], usesOnChanges: true, ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDrag, decorators: [{
      type: Directive,
      args: [{
        selector: "[cdkDrag]",
        exportAs: "cdkDrag",
    ...
    CdkDropListGroup = class _CdkDropListGroup {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _CdkDropListGroup, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-next.2", type: _CdkDropListGroup, isStandalone: true, selector: "[cdkDropListGroup]", inputs: { disabled: ["cdkDropListGroupDisabled", "disabled", booleanAttribute] }, providers: [{ provide: CDK_DROP_LIST_GROUP, useExisting: _CdkDropListGroup }], exportAs: ["cdkDropListGroup"], ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDropListGroup, decorators: [{
      type: Directive,
      args: [{
    ...
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDropList, decorators: [{
      type: Directive,
      args: [{
    ...
    CdkDragPreview = class _CdkDragPreview {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _CdkDragPreview, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "16.1.0", version: "20.2.0-next.2", type: _CdkDragPreview, isStandalone: true, selector: "ng-template[cdkDragPreview]", inputs: { data: "data", matchSize: ["matchSize", "matchSize", booleanAttribute] }, providers: [{ provide: CDK_DRAG_PREVIEW, useExisting: _CdkDragPreview }], ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDragPreview, decorators: [{
      type: Directive,
      args: [{
    ...
    CdkDragPlaceholder = class _CdkDragPlaceholder {
      ...
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _CdkDragPlaceholder, deps: [], target: FactoryTarget.Directive });
      static \u0275dir = \u0275\u0275ngDeclareDirective({ minVersion: "14.0.0", version: "20.2.0-next.2", type: _CdkDragPlaceholder, isStandalone: true, selector: "ng-template[cdkDragPlaceholder]", inputs: { data: "data" }, providers: [{ provide: CDK_DRAG_PLACEHOLDER, useExisting: _CdkDragPlaceholder }], ngImport: core_exports });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: CdkDragPlaceholder, decorators: [{
      type: Directive,
      args: [{
    ...
    DragDropModule = class _DragDropModule {
      static \u0275fac = \u0275\u0275ngDeclareFactory({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDropModule, deps: [], target: FactoryTarget.NgModule });
      static \u0275mod = \u0275\u0275ngDeclareNgModule({ minVersion: "14.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDropModule, imports: [
        CdkDropList,
        CdkDropListGroup,
        CdkDrag,
        CdkDragHandle,
      ...
      static \u0275inj = \u0275\u0275ngDeclareInjector({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: _DragDropModule, providers: [DragDrop], imports: [CdkScrollableModule] });
    };
    \u0275\u0275ngDeclareClassMetadata({ minVersion: "12.0.0", version: "20.2.0-next.2", ngImport: core_exports, type: DragDropModule, decorators: [{
      type: NgModule,
      args: [{
...
// src/app/features/dashboard/products/create-product/create-product.ts
var CreateProduct;
var init_create_product3 = __esm({
  "src/app/features/dashboard/products/create-product/create-product.ts"() {
    ...
    init_box_loader();
    init_drag_drop();
    CreateProduct = class CreateProduct2 {
      router;
      fb;
      cdr;
      route;
      ...
      createFinish;
      createColor;
      imagePreview = [void 0, void 0, void 0, void 0];
      isHovering = false;
      ...
      colorInput;
      typology = true;
      // true for simple, false for variant
      defaultVAriant = 0;
      currentVariant = 0;
      variantPreviews = [[]];
      showDialog = 0;
      ...
      edit = false;
      progress = -1;
      constructor(router, fb, cdr, route, http, cloudy, errorServ) {
        this.router = router;
        this.fb = fb;
        this.cdr = cdr;
        this.route = route;
      ...
      loading = false;
      reorder(event) {
        const list = this.variants.controls[this.currentVariant].get("variantImages")?.value;
      ...
      chargeComponentData() {
        ...
        this.http.getColors().subscribe({
          next: (val) => this.aviavleColors = val,
          error: (err) => {
            this.errorServ.addError(parseError(err));
            this.loading = false;
          }
        ...
        this.http.getFinishes().subscribe({
          next: (val) => this.aviableFinishes = val,
          error: (err) => {
            this.errorServ.addError(parseError(err));
            this.loading = false;
          }
      ...
      setValuesForEdit() {
        if (this.editProduct) {
          ...
          this.finishes = this.editProduct.finish.map((x) => this.aviableFinishes.find((f) => f.id == x.finishId)).filter((x) => x != void 0);
      ...
      getCategory() {
        ...
        return cat ? cat.nombre : "Selecciona una categor\xEDa";
      }
      ...
      onFilesSelected(event, option) {
        if (option == void 0)
          this.fileInputVariants.nativeElement.click();
        else {
          switch (option) {
            case 0:
      ...
      loadImageVariants(files) {
        Promise.all(files.map((f) => this.readFileAsDataURL(f))).then((previews) => {
          this.variantPreviews[this.currentVariant] = previews;
          this.cdr.detectChanges();
        }).catch((err) => {
          console.error("Error leyendo im\xE1genes", err);
        });
      }
      openFinishModal(dialog) {
      ...
      addVariant(id) {
        const variantGroup = this.fb.group({
          ...
          variantImages: [[], [Validators.required, Validators.minLength(5)]]
          // para los archivos
        });
        this.variants.push(variantGroup);
        this.color.push(void 0);
      }
      get variants() {
        return this.createProductForm.get("variants");
      }
      getVariantsImages(variant) {
        return this.variants.controls[variant].get("variantImages")?.value;
      }
      plus() {
      ...
      onSubmit() {
        if (this.createProductForm.valid) {
          ...
          if (this.defaultVAriant !== 0) {
            [reorderedVariants[0], reorderedVariants[this.defaultVAriant]] = [reorderedVariants[this.defaultVAriant], reorderedVariants[0]];
          }
          const body = {
            ...
            vector: this.createProductForm.get("vector")?.value.vector,
            // Placeholder, handle file upload separately
            ...
            variants: reorderedVariants.map((variant) => {
              const varImg = variant.variantImages;
              return {
                id: variant.id,
                stock: variant.stock,
                price: variant.price,
                ...
                image: varImg[0].link,
                // La primera imagen sigue siendo la importante
                images: varImg
              };
            })
          };
      ...
      uploadMulti(files) {
        ...
        var urls = files.map((file) => ({ link: "", public_id: void 0 }));
          ...
          this.cloudy.uploadFile(file).subscribe((event) => {
            if (event.type === HttpEventType.UploadProgress && event.total) {
              ...
              if (this.progress === 100) {
                var currentFiles = this.variants.controls[this.currentVariant].get("variantImages")?.value;
                currentFiles = files.length + currentFiles.length > 5 && files.length < 5 ? currentFiles.slice(currentFiles.length - (5 - files.length), void 0) : files.length == 5 ? [] : currentFiles;
      ...
      onCreateFinish() {
        if (this.createFinish.valid) {
          const image = this.createFinish.get("image")?.value;
          const finish = {
      ...
      showErrors() {
        return this.createProductForm.errors;
      }
      ...
      static propDecorators = {
        ...
        fileInputVariants: [{ type: ViewChild, args: ["fileInputVariants"] }],
        finishInput: [{ type: ViewChild, args: ["finish"] }],
        colorInput: [{ type: ViewChild, args: ["color"] }]
      };
    };
...
// src/app/features/dashboard/products/create-product/create-product.spec.ts
var require_create_product_spec = __commonJS({
  "src/app/features/dashboard/products/create-product/create-product.spec.ts"(exports) {
    init_testing();
...
//# sourceMappingURL=spec-create-product.spec.js.map
